...
// 	};
	...
	FingertricksSolver3x3(): Solver3x3( "U U2 U' R R2 R' F F2 F' D D' r r' M M'" ) {
	...
	void init() {
		...
		forbiddenPairs = { // R r combos wont matter if allowing M moves.
 			{puzzle.getMoveID( "F" ), puzzle.getMoveID( "r2" )},
...
// 			{puzzle.getMoveID( "r2" ), puzzle.getMoveID( "R" )},
		...
		{
			vector<int> pair1 = {
				puzzle.getMoveID( "F" ), puzzle.getMoveID( "F'" ), puzzle.getMoveID( "F2" )
			};
			vector<int> pair2 = {
				puzzle.getMoveID( "D" ), puzzle.getMoveID( "D2" ), puzzle.getMoveID( "D'" ), puzzle.getMoveID( "U" )
			};
			for(auto m1: pair1){
				for(auto m2 : pair2){
					forbiddenPairs.insert({m1, m2});
		...
		{
			vector<int> pair1 = {
				puzzle.getMoveID( "B" ), puzzle.getMoveID( "B'" ), puzzle.getMoveID( "B2" )
			};
			vector<int> pair2 = {
				puzzle.getMoveID( "D" ), puzzle.getMoveID( "D2" ), puzzle.getMoveID( "D'" ), puzzle.getMoveID( "U" )
			};
